 ...
 * this function.
 * *********************************************************/
int WindSpi::spiOpen(std::string devspi){
    int statusVal = -1;
 ...
 * "data".
 * ******************************************************************/
int WindSpi::spiWriteRead( unsigned char *data, int length){
 ...
 * ***********************************************/
WindSpi::WindSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ;
