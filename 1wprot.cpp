...
int main()
{
    ...
    double temp2 = 999999; //because it's meant for 2 sensors for the moment.
    ...
    cout << "Have you changed to the proper path or are you still in test?" << endl;
    ...
    while(1)
    {
        ...
        {
            string prov; // for the moment is saved on a "prov" string, thanks to getline
            getline(data1,prov); //
            if (prov.find("t=",0)!=string::npos) //if there is what I want, "t=", save in the proper line.
            {
                line1 = prov;
            }
        }
        ...
        if (num_sens == 2)
        {
            ...
            {
                string prov;
                getline(data2,prov); // put the text in the string "line#"
                if (prov.find("t=",0)!=string::npos)
                {
                    line2 = prov;
                }
            }
