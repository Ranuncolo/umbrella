//By Paul Harrison
/***********************************************************************
 * This header file contains the WindSpi class definition.
 * Its main purpose is to communicate with the MCP3002 chip using
...
public:
    WindSpi();
    WindSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord);
    ~WindSpi();
