 ...
 *
 ...
 Secondly this program finds the wind direction from the output voltage of the wind vane. The output voltages form plateaus (or here thery are called bands) that indicate direction (i.e. each voltage is associated which a different direction, North, East, etc). WindSpiMain.cpp.Pprogram that tests the WindSpi class.
